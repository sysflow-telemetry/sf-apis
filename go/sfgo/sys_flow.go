...
type SysFlow struct {
	Rec *UnionSFHeaderContainerProcessFileProcessEventNetworkFlowFileFlowFileEventNetworkEventProcessFlow `json:"rec"`
}

const SysFlowAvroCRC64Fingerprint = "\x18P\x88\x9d\x90a\xa7$"
...
func writeSysFlow(r *SysFlow, w io.Writer) error {
	var err error
	err = writeUnionSFHeaderContainerProcessFileProcessEventNetworkFlowFileFlowFileEventNetworkEventProcessFlow(r.Rec, w)
	if err != nil {
		return err
	}
	return err
...
func (r *SysFlow) Get(i int) types.Field {
	switch i {
	case 0:
		r.Rec = NewUnionSFHeaderContainerProcessFileProcessEventNetworkFlowFileFlowFileEventNetworkEventProcessFlow()
